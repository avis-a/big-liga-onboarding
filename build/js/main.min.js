...
/* harmony import */ var _modules_init_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-loader */ "./js/modules/init-loader.js");
/* harmony import */ var _modules_init_animation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-animation */ "./js/modules/init-animation.js");
...
Object(_modules_init_loader__WEBPACK_IMPORTED_MODULE_2__["initLoader"])();
Object(_modules_init_animation__WEBPACK_IMPORTED_MODULE_3__["initAnimation"])();
...
var initLoader = function initLoader() {
  ...
  var containerClickListener = function containerClickListener() {
    closeLoader();
  }; // обработчик нажатия на Enter на лоадере


  var keydownListener = function keydownListener(evt) {
    if (evt.key === 'Enter') {
      closeLoader();
    }
  ...
  var closeLoader = function closeLoader() {
    loadContainer.classList.add('fade-out'); // удаляем обработчики
